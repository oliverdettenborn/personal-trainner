...
export function FeedbackPanel({ 
  ...
  const getColors = () => {
    switch (dotColor) {
      case 'green': return { dot: '#3a8a3a', bg: '#1a3020', border: '#2a6040' };
      case 'amber': return { dot: '#c08030', bg: '#302010', border: '#604020' };
      case 'red': return { dot: '#a03030', bg: '#301010', border: '#602020' };
    }
  };
